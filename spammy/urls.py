...
from spammy.views import spamming_system, ClientListView, NewsletterListView, MessageToSendListView, AttemptToSendListView, ClientCreateView, NewsletterCreateView, MessageToSendCreateView, ClientUpdateView, NewsletterUpdateView, MessageToSendUpdateView, change_status
